...
const Footer = () => {
  return (
    ...
    <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
        <div class="md:max-w-96">
            ...
            <p className="mt-6 text-sm">
                Experience the power os AI with QuickAi <br /> Transform your content with our suite of premium AI tools. Write articles, generate images, and enhance your workflow.
            </p>
        </div>
    ...
    <p className="pt-4 text-center text-xs md:text-sm pb-5">
        Copyright 2025 © Kushagra. All Right Reserved.
    </p>
</footer>
  )
}
